	...
	<div class="container">
		...
		<?php if($load_css_js!=1) { ?>
			<!--<div class="row">
				...
				--><!--<div class="col-xs-12 col-sm-12 col-lg-2 col-md-2 share-sibing text-center"><a id="download_list" class="btn btn-lg btn-success"> <i class="fa fa-cloud-download"></i> <?php //echo $this->lang->line("download pdf");?></a><div class="box box-green no_radius" id="subscribe_div" style="display:none;"></div></div>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title" id="myModalLabel"><span class="fui-export"></span> Enter your email here to grap your reports</h4>
                    </div>
...
$(document).ready(function(){
	...
	$(document).on('click','#download_list',function(){
		...
		{			
			...
			$.ajax({
			url:base_url+'health_check/direct_download_audit',
			type:'POST',
	...
	//	{			
			...
			type:'POST',
			data:{resname:resname,resemail:resemail,hidden_id:hidden_id,report:'audit'},
