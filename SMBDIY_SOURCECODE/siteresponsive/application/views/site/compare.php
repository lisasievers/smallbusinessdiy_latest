...
.compare a{color:#A52A2A;}
input#page_search{width:95%;}
</style>
<?php 
if($compare==1) 
{
		...
		<div class="container-fluid">
			<div class="row">
				<div class="col-md-10 object-non-visible" data-animation-effect="fadeIn">
					<h2 class="text-center product_name"> <span class="thisite"> </span> Vs <span> Competitor?</span></h2>
...
<?php } ?>
				...
				<div class="table-responsive">
					<table class="table table-bordered table-striped table-hover data-table">
						<tr>
							...
							<th class='text-center'>Go compare</th>
						</tr>
						<?php 
						$i=0;
						foreach($recent_search as $row) 
						{
							...
							echo "<tr>";
								...
								echo "<td class='text-center'>";
									...
									echo "<a href='".$details_url."'> <i class='fa fa-file'></i> ".$this->lang->line('report')."</a>";     
								echo "</td>";
								echo "<td class='text-center compare'>";
									$details_url=site_url("home/compare/".$row["id"]);  
									
									echo "<a href='".$details_url."'> <i class='fa fa-compass'></i>Compare me</a>";     
								echo "</td>";
							echo "</tr>";
						}
						?>
	...
	<script type="text/javascript">
		...
		$j(document).ready(function() {
			...
			//Website Name getting
			var href = location.href;
			var siteid=href.match(/([^\/]*)\/*$/)[1];
			$.ajax({
					url:base_url+'home/sitename',
					type:'POST',
					data:{website:siteid},
					dataType:'json',
					success:function(response){			
					$(".thisite").html(response[0]['domain_name']);
					}
