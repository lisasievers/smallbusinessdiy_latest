	...
	<div class="container-fluid">
		...
		<?php if($load_css_js!=1) {?>
			<div class="row">
				<div class="col-xs-10 col-sm-10 col-lg-5 col-md-5 share-container text-center"><?php include("application/views/site/share_button.php");?></div>
				<div class="col-xs-12 col-sm-12 col-lg-4 col-md-4 share-sibing text-center"><!--<a id="add_competutor" class="btn btn-lg btn-primary" href="<?php //echo site_url("home/index/".$site_info[0]["id"]);?>">  <i class="fa fa-adjust"></i> <?php //echo $this->lang->line("compare with competutor");?></a>--></div>
		...
		<?php echo "<div style='font-size:20px !important;margin-top:10px' class='text-center alert alert-".$warning_class."'><b>".$this->config->item('product_short_name')."</b> found <b>".$warning_count."</b> major issues</div>"; ?>
		<div class="row">
			<div class="col-xs-12">				
				<!-- page title start-->
				<?php 
