...
<?php 
	...
	$mobile_ready_data=json_decode($site_info2[0]['mobile_ready_data'],true);
	$pass="Unknown";
	if(isset($mobile_ready_data["ruleGroups"]["USABILITY"]["pass"]))
	$pass=$mobile_ready_data["ruleGroups"]["USABILITY"]["pass"];	
	
	$warning_count2=$site_info2[0]["warning_count"];
	if($pass!="1") $warning_count2++;
	
	$warning_class2="success";
	if($warning_count2>0) $warning_class2="warning";
 ?>
<?php echo "<div style='font-size:22px !important;' class='text-center'><a href='".$site_info[0]["domain_name"]."' target='_BLANK'><b>".$site_info2[0]["domain_name"]."</b></a></div>"; ?>
<?php echo "<div style='font-size:20px !important;' class='text-center alert alert-".$warning_class2."'><b>".$this->config->item('product_short_name')."</b> found <b>".$warning_count2."</b> major issues</div>"; ?>
<div class="row">
<div class="col-xs-12">				
	<!-- page title start-->
	<?php 
	$recommendation_word="Knowledge Base";
	$value=$site_info2[0]["title"];
...
<div class="col-xs-12">				
	...
	<?php 
	$value=$site_info2[0]["description"];
...
<div class="col-xs-12">				
	<!-- meta keyword start-->
	<?php 
	$value=$site_info2[0]["meta_keyword"];
...
<div class="row">
<?php 
$one_phrase=json_decode($site_info2[0]["keyword_one_phrase"],true); 
$two_phrase=json_decode($site_info2[0]["keyword_two_phrase"],true); 
$three_phrase=json_decode($site_info2[0]["keyword_three_phrase"],true); 
$four_phrase=json_decode($site_info2[0]["keyword_four_phrase"],true); 
$total_words=empty($site_info2[0]["total_words"]) ? 0 : $site_info2[0]["total_words"];
...
<div class="col-xs-12">				
	...
	<?php 
	$value=$site_info2[0]["meta_keyword"];
	$check=$this->site_check->keyword_usage_check($site_info2[0]["meta_keyword"],array_keys($one_phrase),array_keys($two_phrase),array_keys($three_phrase),array_keys($four_phrase));
	$item="Keyword Usage";
...
<div class="col-xs-12">				
	<!--total words start-->
	<?php 
	$value=$site_info2[0]["total_words"];
	$item="Total Words";
...
<div class="col-xs-12">				
	...
	<?php 
	$check=round($site_info2[0]["text_to_html_ratio"]); 
...
<div class="row">
<?php 
	$h1=json_decode($site_info2[0]["h1"],true); 
	$h2=json_decode($site_info2[0]["h2"],true); 
	$h3=json_decode($site_info2[0]["h3"],true); 
	$h4=json_decode($site_info2[0]["h4"],true); 
	$h5=json_decode($site_info2[0]["h5"],true); 
	$h6=json_decode($site_info2[0]["h6"],true); 			
?>
<?php 
	$item="HTML Headings";
...
<div class="col-xs-12">				
	<!-- robot start-->
	<?php 
	$value=$site_info2[0]["robot_txt_exist"];
	$check=$value;
	$item="robot.txt";
...
<div class="col-xs-12">				
	<!-- sitemap start-->
	<?php 
	$value=$site_info2[0]["sitemap_exist"];
	$check=$value;
	$item="Sitemap";
	...
	<div class="box box-<?php echo $class;?>">
		...
		<div class="box-body chart-responsive minus">
			<?php echo $short_recommendation; ?>
			<?php if($check=="1") echo "<br>Location: <a href='".$site_info2[0]["sitemap_location"]."' target='_BLANK'>".$site_info2[0]["sitemap_location"]."</a>";else echo "<br/>";?>
			<br/><br/>
			<a  class="recommendation_link" title="<?php echo $item; ?> : <?php echo $recommendation_word; ?>"> <i class="fa fa-book"></i> <b><?php echo $recommendation_word; ?></b></a>
			<div class="recommendation well"><?php echo $long_recommendation; ?></div>
			...
			<div class="row">
				...
				<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
					<div class="info-box" style="border:1px solid #0073B7;border-bottom:2px solid #0073B7;">
						...
						<div class="info-box-content">
							...
							<span class="info-box-number"><?php echo $site_info2[0]["internal_link_count"];?></span>
				...
				<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
					<div class="info-box" style="border:1px solid #0073B7;border-bottom:2px solid #0073B7;">
						...
						<div class="info-box-content">
							...
							<span class="info-box-number"><?php echo $site_info2[0]["external_link_count"];?></span>
						</div><!-- /.info-box-content -->
					</div>
				</div>
				...
				<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">								
					...
					<div class="highlight_header_content">
						<ul>
							<?php 
								$internal_link=json_decode($site_info2[0]["internal_link"],true);											
				...
				<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">								
					...
					<div class="highlight_header_content">
						<ul>
							<?php 
								$external_link=json_decode($site_info2[0]["external_link"],true);
			...
			<div class="row">
				<div class="col-xs-12">
					<div class="info-box" style="border:1px solid #DD4B39;border-bottom:2px solid #DD4B39;">
						...
						<div class="info-box-content">
							...
							<span class="info-box-number"><?php echo count(json_decode($site_info2[0]["noindex_list"],true)); ?></span>
						</div><!-- /.info-box-content -->
					</div>
				</div>
				...
				<div class="col-xs-12">
					<div class="info-box" style="border:1px solid #F39C12;border-bottom:2px solid #F39C12;">
						...
						<div class="info-box-content">
							...
							<span class="info-box-number"><?php echo $site_info2[0]["nofollow_link_count"]; ?></span>
						</div><!-- /.info-box-content -->
					</div>
				</div>
				<div class="col-xs-12">
					<div class="info-box" style="border:1px solid #00A65A;border-bottom:2px solid #00A65A;">
						...
						<div class="info-box-content">
							...
							<span class="info-box-number"><?php echo $site_info2[0]["dofollow_link_count"]; ?></span>
						</div><!-- /.info-box-content -->
					</div>
				</div>
				...
				<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
					<div class="info-box" style="border:1px solid #0073B7;border-bottom:2px solid #0073B7;">
						...
						<div class="info-box-content">
							...
							<span class="info-box-number"><?php echo $site_info2[0]["noindex_by_meta_robot"];?></span>
						</div><!-- /.info-box-content -->
					</div>
				</div>
				...
				<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
					<div class="info-box" style="border:1px solid #0073B7;border-bottom:2px solid #0073B7;">
						...
						<div class="info-box-content">
							...
							<span class="info-box-number"><?php echo $site_info2[0]["nofollowed_by_meta_robot"];?></span>
						</div><!-- /.info-box-content -->
					</div>
				</div>
				...
				<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">								
					...
					<div class="highlight_header_content">
						<ul>
							<?php 
								$noindex_list=json_decode($site_info2[0]["noindex_list"],true);
				...
				<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">								
					...
					<div class="highlight_header_content">
						<ul>
							<?php 
								$nofollow_links=json_decode($site_info2[0]["nofollow_link_list"],true);
...
<div class="col-xs-12">				
	...
	<?php 
	$value=json_decode($site_info2[0]["not_seo_friendly_link"],true);
	$check=count($value);
...
<div class="col-xs-12">				
	<!-- favicon start-->
	<?php 
	$check=$site_info2[0]["is_favicon_found"];
	$item="Favicon";
...
<div class="col-xs-12">				
	<!-- img alt start-->
	<?php 
	$value=json_decode($site_info2[0]["image_not_alt_list"],true);
	$check=$site_info2[0]["image_without_alt_count"];
	$item="Image 'alt' Test";
...
<div class="col-xs-12">				
	<!-- page title start-->
	<?php 
	$value=$site_info2[0]["doctype"];
	$check=$site_info2[0]["doctype_is_exist"]; 
	$item="DOC Type";
...
<div class="col-xs-12">				
	...
	<?php 
	$value=json_decode($site_info2[0]["depreciated_html_tag"],true);
...
<div class="col-xs-12">				
	...
	<?php 
	$value=round($site_info2[0]["total_page_size_general"])." KB";
	$check=$value; 
	$item="HTML Page Size";
...
<div class="col-xs-12">				
	...
	$value=round($site_info2[0]["page_size_gzip"])." KB";
	$check=$site_info2[0]["is_gzip_enable"]; 
	...
	else // ok
	{
		...
		if(round($site_info2[0]["page_size_gzip"]) > 33) 
		{
...
<div class="col-xs-12">				
	<!--  inline css start-->
	<?php 
	$value=json_decode($site_info2[0]["inline_css"],true);
	$check=count($value);
	$item="Inline CSS";
...
<div class="col-xs-12">				
	<!--  inline css start-->
	<?php 
	$value=json_decode($site_info2[0]["internal_css"],true);
	$check=count($value);
	$item="Internal CSS";
...
<div class="col-xs-12">				
	...
	<?php 
	$value=json_decode($site_info2[0]["micro_data_schema_list"],true);
	$check=count($value);
				...
				<div class="col-xs-12">
					<div class="info-box" style="border:1px solid #0073B7;border-bottom:2px solid #0073B7;">
						...
						<div class="info-box-content">
							...
							<span class="info-box-number"><?php echo $site_info2[0]["ip"];?></span>
						</div><!-- /.info-box-content -->
					</div>
				</div>
				...
				<div class="col-xs-12">
					<div class="info-box" style="border:1px solid #0073B7;border-bottom:2px solid #0073B7;">
						...
						<div class="info-box-content">
							...
							<span class="info-box-number"><?php if($site_info2[0]["is_ipv6_compatiable"]==0) echo "Not Compatiable "; else echo $site_info2[0]["ipv6"];?></span>
						</div><!-- /.info-box-content -->
					</div>
				</div>

				<?php 
				$dns_report=json_decode($site_info2[0]["dns_report"],true);
...
<div class="col-xs-12">				
	<!-- ip can start-->
	<?php 
	$check=$site_info2[0]["is_ip_canonical"]; 
...
<div class="col-xs-12">				
	<!-- url can start-->
	<?php 
	$check=$site_info2[0]["is_url_canonicalized"]; 
...
<div class="col-xs-12">				
	<!--  plain email start-->
	<?php 
	$value=json_decode($site_info2[0]["email_list"],true);
	$check=count($value);
		...
		<div class="box-body chart-responsive minus clearfix">
			...
			<div class="row">
				<div class="col-xs-12 table-responsive table-responsive-vertical">
					<?php $curl_response=json_decode($site_info2[0]["general_curl_response"],true) ?>
						<?php 										
	...
	<div class="box box-<?php echo $class;?>">
		...
		<div class="box-body chart-responsive minus clearfix">
			...
			<div class="row">								
				...
				$class="blue-dark";
				$status="info-circle";	
				$value=$site_info2[0]['speed_score_mobile'];			
				?>
				<?php if($load_css_js!=1) {?>
				<div class="col-xs-12 table-responsive">
					<div class="box box-<?php echo $class;?>">
						...
						<div class="box-body chart-responsive table-responsive minus clearfix">
							<input id="mobile_speed2" type="hidden" value="<?php echo $value; ?>" />
						</div>
					</div>	
				</div>
				<?php } else { ?>
				...
				$class="blue-dark";
				$status="info-circle";		
				$value=$site_info2[0]['speed_usability_mobile'];		
				?>
				...
				<div class="col-xs-12 table-responsive">								
					<div class="box box-<?php echo $class;?>">
						...
						<div class="box-body chart-responsive table-responsive minus clearfix">
							<input id="mobile_usability2" type="hidden" value="<?php echo $value; ?>" />
						</div>
					</div>							
				</div> <!-- col end -->
				...
				<div class="col-xs-12">
					<div class="box box-<?php echo $class;?>">
						...
						<div class="box-body chart-responsive table-responsive  table-responsive-vertical minus clearfix">
							<?php $curl_response=json_decode($site_info2[0]["pagestat_mobile"],true) ?>
								<?php 										
			...
			<div class="row">							
				<div class="col-xs-12">
					...
					$value=json_decode($site_info2[0]["avoid_interstitials_mobile"],true);
			...
			<div class="row">							
				<div class="col-xs-12">
					<?php 
					$item="Avoid Plugins";				
					$value=json_decode($site_info2[0]["avoid_plugins_mobile"],true);
			...
			<div class="row">							
				<div class="col-xs-12">
					...
					$value=json_decode($site_info2[0]["configure_viewport_mobile"],true);
			...
			<div class="row">							
				<div class="col-xs-12">
					...
					$value=json_decode($site_info2[0]["size_content_to_viewport_mobile"],true);
					$check=$value["rule_impact"];
			...
			<div class="row">							
				<div class="col-xs-12">
					...
					$value=json_decode($site_info2[0]["size_tap_targets_appropriately_mobile"],true);
					$check=$value["rule_impact"];
					if(is_numeric($check) && $check>0)
					{
						$class="red";
			...
			<div class="row">							
				<div class="col-xs-12">
					...
					$value=json_decode($site_info2[0]["use_legible_font_sizes_mobile"],true);
					$check=$value["rule_impact"];
					if(is_numeric($check) && $check>0)
					{
						$class="red";
			...
			<div class="row">							
				<div class="col-xs-12">
					...
					$value=json_decode($site_info2[0]["avoid_landing_page_redirects_mobile"],true);
			...
			<div class="row">							
				<div class="col-xs-12">
					<?php 
					$item="GZIP Compression";				
					$value=json_decode($site_info2[0]["gzip_compression_mobile"],true);
					$check=$value["rule_impact"];
			...
			<div class="row">
				<div class="col-xs-12">
					...
					$value=json_decode($site_info2[0]["leverage_browser_caching_mobile"],true);
					$check=$value["rule_impact"];
					if(is_numeric($check) && $check>0)
					{
						$class="red";
			...
			<div class="row">
				<div class="col-xs-12">
					...
					$value=json_decode($site_info2[0]["main_resource_server_response_time_mobile"],true);
					$check=$value["rule_impact"];
					if(is_numeric($check) && $check>0)
					{
						$class="red";
			...
			<div class="row">							
				<div class="col-xs-12">
					<?php 
					$item="Minify CSS";				
					$value=json_decode($site_info2[0]["minify_css_mobile"],true);
					$check=$value["rule_impact"];
					if(is_numeric($check) && $check>0)
					{
						$class="red";
			...
			<div class="row">							
				<div class="col-xs-12">
					<?php 
					$item="Minify HTML";				
					$value=json_decode($site_info2[0]["minify_html_mobile"],true);
					$check=$value["rule_impact"];
					if(is_numeric($check) && $check>0)
					{
						$class="red";
			...
			<div class="row">							
				<div class="col-xs-12">
					...
					$value=json_decode($site_info2[0]["minify_javaScript_mobile"],true);
					$check=$value["rule_impact"];
					if(is_numeric($check) && $check>0)
					{
						$class="red";
			...
			<div class="row">							
				<div class="col-xs-12">
					...
					$value=json_decode($site_info2[0]["minimize_render_blocking_resources_mobile"],true);
					$check=$value["rule_impact"];
					if(is_numeric($check) && $check>0)
					{
						$class="red";
			...
			<div class="row">							
				<div class="col-xs-12">
					...
					$value=json_decode($site_info2[0]["optimize_images_mobile"],true);
					$check=$value["rule_impact"];
			...
			<div class="row">							
				<div class="col-xs-12">
					...
					$value=json_decode($site_info2[0]["prioritize_visible_content_mobile"],true);
					$check=$value["rule_impact"];
					if(is_numeric($check) && $check>0)
					{
						$class="red";
		...
		<div class="box-body chart-responsive minus clearfix">
			...
			<div class="row">
				...
				<div class="col-xs-12 table-responsive">
					<div class="box box-<?php echo $class;?>">
						...
						<div class="box-body chart-responsive table-responsive table-responsive-vertical minus clearfix">
							<?php $curl_response=json_decode($site_info2[0]["pagestat"],true) ?>
								<?php 										
									echo "<br><table class='table table-striped table-bordered'>";
									$sl=0;
									foreach ($curl_response as $key=>$value) 
				...
				<?php 
					...
					$class="blue-dark";
					$status="info-circle";	
					$value=$site_info2[0]['speed_score'];			
				?>
				<?php if($load_css_js!=1) { ?>
				<div class="col-xs-12 table-responsive">								
					<div class="box box-<?php echo $class;?>">
						...
						<div class="box-body chart-responsive table-responsive minus clearfix">
							<input id="desktop_speed2" type="hidden" value="<?php echo $value; ?>" />
						</div>
					</div>							
				</div> <!-- col end -->
			...
			<div class="row">							
				<div class="col-xs-12">
					<?php 
					$item="Landing Page Redirects";				
					$value=json_decode($site_info2[0]["avoid_landing_page_redirects"],true);
					$check=$value["redirect_count"];
					if(is_numeric($check) && $check>0)
					{
						$class="red";
			...
			<div class="row">							
				<div class="col-xs-12">
					<?php 
					$item="GZIP Compression";				
					$value=json_decode($site_info2[0]["gzip_compression"],true);
					$check=$value["rule_impact"];
					$size_compressable=$value["total_size_compressable"];
					$percent_compressable=$value["total_percentage_compressable"];
					if(is_numeric($check) && $check>0)
			...
			<div class="row">
				<div class="col-xs-12">
					<?php 
					$item="Leverage Browser Caching";				
					$value=json_decode($site_info2[0]["leverage_browser_caching"],true);
					$check=$value["rule_impact"];
					if(is_numeric($check) && $check>0)
					{
						$class="red";
			...
			<div class="row">
				<div class="col-xs-12">
					<?php 
					$item="Server Response Time";				
					$value=json_decode($site_info2[0]["main_resource_server_response_time"],true);
					$check=$value["rule_impact"];
					if(is_numeric($check) && $check>0)
					{
						$class="red";
			...
			<div class="row">							
				<div class="col-xs-12">
					<?php 
					$item="Minify CSS";				
					$value=json_decode($site_info2[0]["minify_css"],true);
					$check=$value["rule_impact"];
					if(is_numeric($check) && $check>0)
					{
						$class="red";
			...
			<div class="row">							
				<div class="col-xs-12">
					<?php 
					$item="Minify HTML";				
					$value=json_decode($site_info2[0]["minify_html"],true);
					$check=$value["rule_impact"];
					if(is_numeric($check) && $check>0)
					{
						$class="red";
			...
			<div class="row">							
				<div class="col-xs-12">
					<?php 
					$item="Minify JavaScript";				
					$value=json_decode($site_info2[0]["minify_javaScript"],true);
					$check=$value["rule_impact"];
					if(is_numeric($check) && $check>0)
					{
						$class="red";
			...
			<div class="row">							
				<div class="col-xs-12">
					<?php 
					$item="Render-blocking JavaScript and CSS";				
					$value=json_decode($site_info2[0]["minimize_render_blocking_resources"],true);
					$check=$value["rule_impact"];
					if(is_numeric($check) && $check>0)
					{
						$class="red";
			...
			<div class="row">							
				<div class="col-xs-12">
					<?php 
					$item="Optimize Images";				
					$value=json_decode($site_info2[0]["optimize_images"],true);
					$check=$value["rule_impact"];
					$size_compressable=$value["total_size_optimizable"];
					$percent_compressable=$value["total_percentage_optimizable"];
					if(is_numeric($check) && $check>0)
			...
			<div class="row">							
				<div class="col-xs-12">
					<?php 
					$item="Prioritize Visible Content";				
					$value=json_decode($site_info2[0]["prioritize_visible_content"],true);
					$check=$value["rule_impact"];
					if(is_numeric($check) && $check>0)
					{
						$class="red";
