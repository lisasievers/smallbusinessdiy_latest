     	...
     	<div class="box box-info custom_box">
		    ...
		    <form class="form-horizontal" enctype="multipart/form-data" action="<?php echo site_url().'admin_config/edit_config';?>" method="POST">
		        <div class="box-body">
		           ...
		           <div class="form-group">
		             	<label class="col-sm-3 control-label" for=""><?php echo $this->lang->line("product version");?> 
		             	</label>
	             		<div class="col-sm-9 col-md-6 col-lg-6">
	               			<input name="product_version" value="<?php echo $this->config->item('product_version');?>"  class="form-control" type="text">		          
	             			<span class="red"><?php echo form_error('product_version'); ?></span>
	             		</div>
		           </div>  
