  ...
  <div class="row row-centered">
    ...
    <div class="account-wall" id='recovery_form'> 
        <div class="form-group">
           <div id='msg'></div>
           <label class="col-xs-12" style="margin-left:0;padding-left:0;"><?php echo $this->lang->line("email"); ?></label>
           <input required type="email" class="form-control col-xs-12" id="email" placeholder="<?php echo $this->lang->line("email"); ?>">          
        </div>       
        <div class="form-group">
      ...
      $.ajax({
        ...
        success:function(response){
          ...
          if(response=='0')
          {
            ...
            $("#msg").html("<?php echo $this->lang->line('this email is not associated with any user');?>");
          }
          else
          {
            var string="<div class='well'>"+ 
              ...
              "</ol>"+
              "<h4><?php echo $this->lang->line('link and code will be expired after 24 hours'); ?></h4>"+
            "</div>";
