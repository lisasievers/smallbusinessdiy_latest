<?php 
  ...
  if(function_exists('ini_get')){
    ...
    if(ini_get('open_basedir')=="")
      ...
      $install_allow = 0;
      $open_basedir="<div class='alert alert-danger'><i class='fa fa-times-circle'></i> <b>open basedir</b>Error. open_basedir has value. Please clear value for open_basedir from php.ini</div>";
    }
    
    if(ini_get('allow_url_fopen'))
      $allow_url_fopen="<div class='alert alert-success'><i class='fa fa-check-circle'></i> <b>allow url open : </b>Ok. Enabled</div>";
    else{
      $install_allow = 0;
      $allow_url_fopen="<div class='alert alert-danger'><i class='fa fa-times-circle'></i> <b>allow url open : </b>Error. Please make allow_url_fopen=1 from php.ini file</div>";
    }
    
  }
  
  if(function_exists('mysqli_connect'))
    $mysqli_support="<div class='alert alert-success'><i class='fa fa-check-circle'></i> <b>mysqli support : </b>Ok. Supported</div>";
  else{
    $install_allow = 0;
    $mysqli_support="<div class='alert alert-danger'><i class='fa fa-times-circle'></i> <b>mysqli support : </b>Error. MySql Support is not available. Please enable MySql Support.</div>";
  }
?>
      ...
      <form class="form-horizontal" action="<?php echo site_url().'home/installation_action';?>" method="POST">
        ...
        <div class="form-group">
            <label>Language  </label>                   
              ...
              ?>
              <select name="language" autocomplete="off" id="language" class="form-control">
                <?php 
      ...
      <div class="alert alert-warning">
        ...
        <p>
          <ul>
            ...
            <li>Folder : js/analytics_js (777)</li>
