  ...
  <body class="login-page">
    <div class="login-box">
      <div class="login-logo">
        <center><a href="<?php echo site_url();?>">Site Checkup</a></center><br/>
       </div><!-- /.login-logo -->
      ...
      <br/><center><a style="font-family: 'Times New Roman'" href="<?php echo site_url();?>home/forgot_password"><?php echo $this->lang->line("forget password"); ?></a></center>      </div><!-- /.login-box-body -->
    </div><!-- /.login-box -->
