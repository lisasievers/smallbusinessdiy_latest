...
<section class="content-header">
	<h1 class = 'text-info'><?php echo $this->lang->line("link analyzer");?></h1>
</section>
	...
	<div class="row" >
		<div class="col-xs-12">
			<div class="grid_container" style="width:100%; min-height:760px;">
				...
				url="<?php echo base_url()."link_analysis/link_analysis_data"; ?>" 
				...
				>
					...
					<thead>
						<tr>
							...
							<th field="external_link_count" sortable="true">Externnal Links</th>
							<th field="internal_link_count" sortable="true">Internal Links</th>
							<th field="nofollow_count" sortable="true">NoFollow Links</th>
							<th field="do_follow_count" sortable="true">DoFollow Links</th>
	...
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			...
			<div class="modal-header">
				...
				<h4 id="new_search_details_title" class="modal-title"><i class="fa fa-binoculars"></i> <?php echo $this->lang->line("link analyzer");?></h4>
			</div><br/>
				...
				<form enctype="multipart/form-data" method="post" class="form-inline" id="new_search_form" style="margin-bottom:10px">
					...
					<div class="row">						
						<div class="form-group col-xs-12 col-sm-12 col-md-6 col-lg-6">
							<input id="bulk_file" type="text" class="form-control" placeholder="URL" style="width:100%"/>
						</div>								
...
<script>
	...
	$(".download").click(function(){
		...
		var url = "<?php echo site_url('link_analysis/link_analysis_download');?>";
	...
	$(".delete").click(function(){
		...
		if(result)
		{
			...
			var base_url="<?php echo base_url(); ?>";		
			var url = "<?php echo site_url('link_analysis/link_analysis_delete');?>";
	        var rows = $j("#tt").datagrid("getSelections");
	        var info=JSON.stringify(rows); 
	...
	function get_bulk_progress()
	{
		var base_url="<?php echo base_url(); ?>";			
		$.ajax({
			url:base_url+'link_analysis/bulk_link_analysis_progress_count',
			type:'POST',
			dataType:'json',
			success:function(response){
				...
				if(width==100) 
				{
					...
					$("#download_div").html('<center><a style="margin: 0px auto;" href="<?php echo base_url()."download/link/link_analysis_".$this->user_id."_".$this->session->userdata("download_id").".csv"; ?>" target="_blank" class="btn btn-lg btn-warning"><i class="fa fa-cloud-download"></i> <b><?php echo $this->lang->line("download"); ?></b></a></center>');
	...
	$j("document").ready(function(){
		...
		$("#new_search_button").on('click',function(){
			...
			$.ajax({
				url:base_url+'link_analysis/link_analysis_action',
				type:'POST',
				data:{urls:urls},
				success:function(response){		
					...
					<div class="row">
						<div class="col-xs-12 col-sm-12 col-md-8 col-md-offset-2 col-lg-8 col-lg-offset-2">
							...
							<?php 
								...
								echo "<a href='".base_url()."download/link/link_analysis_".$this->user_id."_".$download_id.".csv"."'". "title='Download' class='btn btn-warning btn-lg' style='width:200px;'><i class='fa fa-cloud-download' style='color:white'></i>  ".$this->lang->line('download')."</a>";							
							?>
							</div>		
