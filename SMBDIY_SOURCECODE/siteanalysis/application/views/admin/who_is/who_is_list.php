...
<section class="content-header">
	<h1 class = 'text-info'> <?php echo $this->lang->line("whois search");?></h1>
</section>
	...
	<div class="row" >
		<div class="col-xs-12">
			<div class="grid_container" style="width:100%; min-height:760px;">
				...
				url="<?php echo base_url()."who_is/who_is_list_data"; ?>" 
				...
				>
					...
					<thead>
						<tr>
							...
							<th field="owner_email" sortable="true">Owner Email</th>
							<th field="admin_name" sortable="true">Admin Name</th>
							<th field="admin_email" sortable="true">Admin Email</th>
							<th field="admin_country" sortable="true">Admin Country</th>
							<th field="admin_phone" sortable="true">Admin Phone No.</th>				
							<th field="admin_street" sortable="true">Admin Street</th>
							<th field="admin_city" sortable="true">Admin City</th>
							<th field="admin_state" sortable="true">Admin State</th>
							<th field="admin_postal_code" sortable="true">Admin Postal Code</th>							
							<th field="tech_email" sortable="true">Tech. Email</th>
							<th field="registrant_email" sortable="true">Registrant Email</th>
							<th field="registrant_name" sortable="true">Registrant Name</th>
							<th field="registrant_organization" sortable="true">Registrant Organization</th>
							<th field="registrant_street" sortable="true">Registrant Street</th>
							<th field="registrant_city" sortable="true">Registrant City</th>
							<th field="registrant_state" sortable="true">Registrant State</th>
							<th field="registrant_postal_code" sortable="true">Registrant Postal Code</th>
							<th field="registrant_country" sortable="true">Registrant Country</th>
							<th field="registrant_phone" sortable="true">Registrant Phone</th>
							<th field="registrar_url" sortable="true">Registrant URL</th>
							<th field="is_registered" sortable="true">Is Registered</th>
							...
							<th field="expire_at" sortable="true">Expired At</th>
							<th field="scraped_time" sortable="true">Searched At</th>
							<!-- <th field="rawdata" sortable="true">rawdata</th> -->
							<th field="bulk_track_code" sortable="true">Bulk Track Code</th>
			...
			<form class="form-inline" style="margin-top:20px">
				...
				<button type="button" style="width:200px;" class="btn btn-info download" id = "download_btn_all"><i class="fa fa-cloud-download"></i> <?php echo $this->lang->line("download all");?>l</button>
	...
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			...
			<div class="modal-header">
				...
				<h4 id="new_search_details_title" class="modal-title"><i class="fa fa-binoculars"></i> <?php echo $this->lang->line("whois search");?></h4>
			</div><br/>
...
<script>
	...
	$(".download").click(function(){
		...
		var url = "<?php echo site_url('who_is/who_is_download');?>";
	...
	$(".delete").click(function(){
		...
		if(result)
		{
			...
			var base_url="<?php echo base_url(); ?>";		
			var url = "<?php echo site_url('who_is/who_is_delete');?>";
	        var rows = $j("#tt").datagrid("getSelections");
	        var info=JSON.stringify(rows); 
	...
	function get_bulk_progress()
	{
		var base_url="<?php echo base_url(); ?>";			
		$.ajax({
			url:base_url+'who_is/bulk_scan_progress_count',
			type:'POST',
			dataType:'json',
			success:function(response){
				...
				if(width==100) 
				{
					...
					$("#download_div").html('<center><a style="margin: 0px auto;" href="<?php echo base_url()."download/who_is/who_is_".$this->user_id."_".$this->session->userdata("download_id").".csv"; ?>" target="_blank" class="btn btn-lg btn-warning"><i class="fa fa-cloud-download"></i> <b><?php echo $this->lang->line("download"); ?></b></a></center>');
	...
	$j("document").ready(function(){
		...
		$("#new_search_button").on('click',function(){
			...
			$.ajax({
				url:base_url+'who_is/who_is_action',
				type:'POST',
				data:{urls:urls},
				success:function(response){		
					...
					$("#download_div").html('<center><a style="margin: 0px auto;" href="<?php echo base_url()."download/who_is/who_is_".$this->user_id."_".$this->session->userdata("download_id").".csv"; ?>" target="_blank" class="btn btn-lg btn-warning"><i class="fa fa-cloud-download"></i> <b>Download</b></a></center>');
					$j("#tt").datagrid('reload');					
				}
					...
					<div class="row">
						<div class="col-xs-12 col-sm-12 col-md-8 col-md-offset-2 col-lg-8 col-lg-offset-2">
							...
							<?php 
								...
								echo "<a href='".base_url()."download/who_is/who_is_".$this->user_id."_".$download_id.".csv"."'". "title='Download' class='btn btn-warning btn-lg' style='width:200px;'><i class='fa fa-cloud-download' style='color:white'></i>".$this->lang->line('download')." </a>";							
							?>
							</div>		
