...
<section class="content-header">
	<h1 class = 'text-info'><?php echo $this->lang->line("google url shortener");?></h1>
</section>
	...
	<div class="row" >
		<div class="col-xs-12">
			<div class="grid_container" style="width:100%; min-height:760px;">
				...
				url="<?php echo base_url()."url_shortener/url_shortener_data"; ?>" 
				...
				>
					...
					<thead>
						<tr>
							...
							<th field="long_url" sortable="true"><?php echo $this->lang->line('original url'); ?></th>
							<th field="short_url" sortable="true"><?php echo $this->lang->line('short url'); ?></th>
							<th field="add_date" sortable="true"><?php echo $this->lang->line('create date'); ?></th>
			...
			<div class="row">
				<div class="col-xs-12">
					<button type="button" style="width:200px;" class="btn btn-primary" id ="new_search_modal_open"><i class="fa fa-cut"></i> <?php echo $this->lang->line("create new short url");?></button>
				</div>
			</div>
			...
			<form class="form-inline" style="margin-top:20px">
				...
				<div class="form-group">
					<input id="short_url" name="short_url" class="form-control" size="20" placeholder="<?php echo $this->lang->line('short url');?>">
				</div>

				<div class="form-group">
					<input id="original_url" name="original_url" class="form-control" size="20" placeholder="<?php echo $this->lang->line('original url');?>">
				</div>  
	...
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			...
			<div class="modal-header">
				...
				<h4 id="new_search_details_title" class="modal-title"><i class="fa fa-cut"></i> <?php echo $this->lang->line("create new short url");?></h4>
			</div><br/>
				...
				<form enctype="multipart/form-data" method="post" class="form-inline" id="new_search_form" style="margin-bottom:10px">
					...
					<div class="row">						
						<div class="form-group col-xs-12 col-sm-12 col-md-12 col-lg-12">
							<?php echo $this->lang->line("Enter your original url here");?><br/>
							<textarea id="bulk_file" style="width:100%;padding:10px;" rows="7" placeholder="<?php echo $this->lang->line("put your original urls or upload text/csv file - comma / new line separated"); ?>"></textarea>					
					...
					<div class="row">						
						...
						<div class="form-group col-xs-12 col-sm-12 col-md-7 col-lg-7 clearfix">						
							...
							<button type="button"  id="new_search_button" class="btn btn-info pull-right"><i class="fa fa-binoculars"></i> <?php echo $this->lang->line("start shortening"); ?></button>   
						</div>
					</div>
...
<script> 
	...
	$(".delete").click(function(){
		...
		if(result)
		{
			...
			var base_url="<?php echo base_url(); ?>";		
			var url = "<?php echo site_url('url_shortener/short_url_delete');?>";
	        var rows = $j("#tt").datagrid("getSelections");
	        var info=JSON.stringify(rows); 
	...
	function doSearch(event)
	{
		...
		$j('#tt').datagrid('load',{
			original_url    :     $j('#original_url').val(),              
			short_url       :     $j('#short_url').val(),              
	...
	function get_bulk_progress()
	{
		var base_url="<?php echo base_url(); ?>";			
		$.ajax({
			url:base_url+'url_shortener/bulk_url_short_progress_count',
			type:'POST',
			dataType:'json',
			success:function(response){
				...
				if(width==100) 
				{
					...
					$("#download_div").html('<center><a style="margin: 0px auto;" href="<?php echo base_url()."download/url_shortener/short_url_".$this->user_id."_".$this->session->userdata("download_id").".csv"; ?>" target="_blank" class="btn btn-lg btn-warning"><i class="fa fa-cloud-download"></i> <b><?php echo $this->lang->line("download"); ?></b></a></center>');
	...
	$j("document").ready(function(){
		...
		$("#new_search_button").on('click',function(){
			...
			$.ajax({
				url:base_url+'url_shortener/url_shortener_action',
				type:'POST',
				data:{urls:urls},
				success:function(response){		
					...
					<div class="row">
						<div class="col-xs-12 col-sm-12 col-md-8 col-md-offset-2 col-lg-8 col-lg-offset-2">
							...
							<?php 
								...
								echo "<a href='".base_url()."download/url_shortener/short_url_".$this->user_id."_".$download_id.".csv"."'". "title='Download' class='btn btn-warning btn-lg' style='width:200px;'><i class='fa fa-cloud-download' style='color:white'></i> ".$this->lang->line('download')."</a>";							
							?>
							</div>		
