...
<section class="content-header">
	<h1 class = 'text-info'> <?php echo $this->lang->line("social network analysis");?></h1>
</section>
	...
	<div class="row" >
		<div class="col-xs-12">
			<div class="grid_container" style="width:100%; min-height:650px;">
				...
				url="<?php echo base_url()."social/social_list_data"; ?>" 
				...
				>
					...
					<thead>
						<tr>
							...
							<!-- <th field="fb_like" sortable="true"><?php echo $this->lang->line("facebook like");?></th> -->
							<th field="fb_share" sortable="true"><?php echo $this->lang->line("facebook share");?></th>
							<!-- <th field="fb_comment" sortable="true"><?php echo $this->lang->line("facebook comment");?></th> -->
							<th field="google_plus_count" sortable="true"><?php echo $this->lang->line("google+ count");?></th>
							<th field="linked_in_share" sortable="true"><?php echo $this->lang->line("linkedin share");?></th>
							<th field="xing_share_count" sortable="true"><?php echo $this->lang->line("xing share");?></th>
							<th field="reddit_score" sortable="true"><?php echo $this->lang->line("reddit score");?></th>
							<th field="reddit_up" sortable="true"><?php echo $this->lang->line("reddit up");?></th>
							<th field="reddit_dowon" sortable="true"><?php echo $this->lang->line("reddit down");?></th>
							<th field="pinterest_pin" sortable="true"><?php echo $this->lang->line("pinterest pin");?></th>
							<th field="buffer_share" sortable="true"><?php echo $this->lang->line("buffer share");?></th>
							<th field="stumbleupon_view" sortable="true"><?php echo $this->lang->line("stumbleupon view");?></th>
							<th field="stumbleupon_like" sortable="true"><?php echo $this->lang->line("stumbleupon like");?></th>
							<th field="stumbleupon_comment" sortable="true"><?php echo $this->lang->line("stumbleupon comment");?></th>
							<th field="stumbleupon_list" sortable="true"><?php echo $this->lang->line("stumbleupon list");?></th>
							<th field="search_at" sortable="true">Analysis at</th>
						</tr>
					</thead>
				</table>                        
			</div>
			...
			<div class="row">
				<div class="col-xs-12">
					<button type="button" class="btn btn-primary" id ="new_search_modal_open"><i class="fa fa-hourglass-start"></i> <?php echo $this->lang->line("new analysis");?></button>
				</div>
			</div>
	...
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			...
			<div class="modal-header">
				...
				<h4 id="new_search_details_title" class="modal-title"><i class="fa fa-share-alt"></i> <?php echo $this->lang->line("social network analysis");?></h4>
			</div><br/>
				...
				<form enctype="multipart/form-data" method="post" class="form-inline" id="new_search_form" style="margin-bottom:10px">
					...
					<div class="row">
						<div class="col-xs-6 col-sm-6 col-md-3 col-lg-3">
							<label><input type="checkbox" id="social_facbook" value="google" checked="true"> Facebook</label>
						</div>
						<div class="col-xs-6 col-sm-6 col-md-3 col-lg-3">
							<label><input type="checkbox" id="social_linkedin" value="mcafee" checked="true"> Linkedin</label>
						</div>
						<div class="col-xs-6 col-sm-6 col-md-3 col-lg-3">
							<label><input type="checkbox" id="social_googleplus" value="avg" checked="true"> Google+</label>
						</div>
						<div class="col-xs-6 col-sm-6 col-md-3 col-lg-3">
							<label><input type="checkbox" id="social_xing" value="norton" checked="true"> Xing</label>
						</div>	
					</div>
					<br/>
					<div class="row">
						<div class="col-xs-6 col-sm-6 col-md-3 col-lg-3">
							<label><input type="checkbox" id="social_reddit" value="google" checked="true"> Reddit</label>
						</div>
						<div class="col-xs-6 col-sm-6 col-md-3 col-lg-3">
							<label><input type="checkbox" id="social_pinterest" value="mcafee" checked="true"> Pinterest</label>
						</div>
						<div class="col-xs-6 col-sm-6 col-md-3 col-lg-3">
							<label><input type="checkbox" id="social_buffer" value="avg" checked="true"> Buffer</label>
						</div>
						<div class="col-xs-6 col-sm-6 col-md-3 col-lg-3">
							<label><input type="checkbox" id="social_stumbleupon" value="norton" checked="true"> StumbleUpon</label>
						</div>	
					</div>
					<br/>
					<div class="row">						
					...
					<div class="row">						
						...
						<div class="form-group col-xs-12 col-sm-12 col-md-7 col-lg-7 clearfix">						
							...
							<button type="button"  id="new_search_button" class="btn btn-info pull-right"><i class="fa fa-hourglass-start"></i> <?php echo $this->lang->line("start analysis"); ?></button>   
						</div>
					</div>
...
<script>
	...
	$(".download").click(function(){
		...
		var url = "<?php echo site_url('social/social_download');?>";
	...
	$(".delete").click(function(){
		...
		if(result)
		{
			...
			var base_url="<?php echo base_url(); ?>";		
			var url = "<?php echo site_url('social/social_delete');?>";
	        var rows = $j("#tt").datagrid("getSelections");
	        var info=JSON.stringify(rows); 
	...
	function get_bulk_progress()
	{
		var base_url="<?php echo base_url(); ?>";			
		$.ajax({
			url:base_url+'social/bulk_scan_progress_count',
			type:'POST',
			dataType:'json',
			success:function(response){
				...
				if(width==100) 
				{
					$("#progress_msg_text").html("<?php echo $this->lang->line('analysis completed'); ?>");
					$("#success_msg").html('<center><h3 style="color:olive;"><?php echo $this->lang->line("completed"); ?></h3></center>');
					$("#download_div").html('<center><a style="margin: 0px auto;" href="<?php echo base_url()."download/social/social_".$this->user_id."_".$this->session->userdata("download_id").".csv"; ?>" target="_blank" class="btn btn-lg btn-warning"><i class="fa fa-cloud-download"></i> <b><?php echo $this->lang->line("download"); ?></b></a></center>');
	...
	$j("document").ready(function(){
		...
		$("#new_search_button").on('click',function(){
			...
			var is_facebook=0;
			if ($('#social_facbook').is(":checked"))
			var is_facebook=1;

			var is_linkedin=0;
			if ($('#social_linkedin').is(":checked"))
			var is_linkedin=1;

			var is_googleplus=0;
			if ($('#social_googleplus').is(":checked"))
			var is_googleplus=1;

			var is_xing=0;
			if ($('#social_xing').is(":checked"))
			var is_xing=1;

			var is_reddit=0;
			if ($('#social_reddit').is(":checked"))
			var is_reddit=1;

			var is_pinterest=0;
			if ($('#social_pinterest').is(":checked"))
			var is_pinterest=1;

			var is_buffer=0;
			if ($('#social_buffer').is(":checked"))
			var is_buffer=1;

			var is_stumbleupon=0;
			if ($('#social_stumbleupon').is(":checked"))
			var is_stumbleupon=1;
			...
			{
				alert("<?php echo $this->lang->line('please select social network'); ?>");
				return false;
			}
			...
			$.ajax({
				...
				type:'POST',
				data:{urls:urls,is_facebook:is_facebook,is_linkedin:is_linkedin,is_googleplus:is_googleplus,is_xing:is_xing,is_reddit:is_reddit,is_pinterest:is_pinterest,is_buffer:is_buffer,is_stumbleupon:is_stumbleupon},
				success:function(response){	
					$("#live_data").show();		
					...
					<div class="row">
						<div class="col-xs-12 col-sm-12 col-md-8 col-md-offset-2 col-lg-8 col-lg-offset-2">
							...
							<?php 
								...
								echo "<a href='".base_url()."download/social/social_".$this->user_id."_".$download_id.".csv"."'". "title='Download' class='btn btn-warning btn-lg' style='width:200px;'><i class='fa fa-cloud-download' style='color:white'></i>".$this->lang->line('download')."</a>";							
							?>
							</div>		
