...
<section class="content-header">
	<h1 class = 'text-info'><?php echo $this->lang->line("keyword position analysis");?> </h1>
</section>
	...
	<div class="row" >
		<div class="col-xs-12">
			<div class="grid_container" style="width:100%; min-height:760px;">
				...
				url="<?php echo base_url()."keyword/keyword_position_data"; ?>" 
				...
				>
					...
					<thead>
						<tr>
							...
							<th field="location" sortable="true">Location</th>
							<th field="language" sortable="true">Language</th>
							<th field="proxy" sortable="true">Proxy</th>
							<th field="google_position" sortable="true">Google Position</th>
							<th field="bing_position" sortable="true">Bing Position</th>
							<th field="yahoo_position" sortable="true">Yahoo Position</th>
			...
			<div class="row">
				<div class="col-xs-12">
					<button type="button" style="width:220px;" class="btn btn-primary" id ="new_search_modal_open"><i class="fa fa-tags"></i> <?php echo $this->lang->line("keyword position analysis");?> </button>
				</div>
			</div>
			...
			<form class="form-inline" style="margin-top:20px">
				...
				<div class="form-group">
					<input id="search_domain" name="search_domain" class="form-control" size="20" placeholder="Website URL">
				</div>
	...
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			...
			<div class="modal-header">
				...
				<h4 id="new_search_details_title" class="modal-title"><i class="fa fa-tags"></i> <?php echo $this->lang->line("keyword position analysis");?> </h4>
			</div><br/>
				...
				<form enctype="multipart/form-data" method="post" class="form-inline" id="new_search_form" style="margin-bottom:10px">
					...
					<div class="row">						
						<div class="form-group col-xs-12 col-sm-12 col-md-6 col-lg-6">
							<br/><input type="text" id="domain_name" placeholder="Website URL *" style="width:100%" class="form-control"/>
						</div>
						<div class="form-group col-xs-12 col-sm-12 col-md-6 col-lg-6">
						...
						<div class="form-group col-xs-12 col-sm-12 col-md-6 col-lg-6">
							<br/>
							<?php 
							$country_name['']=$this->lang->line("any location");
						...
						<div class="form-group col-xs-12 col-sm-12 col-md-6 col-lg-6">
							<br/>
							<?php 
							$language_name['']=$this->lang->line("any language");
					...
					<div class="row">	
						<div class="form-group col-xs-12 col-sm-12 col-md-7 col-lg-7 clearfix">	
							<button type="button"  id="new_search_button" class="btn btn-info pull-left"><i class="fa fa-hourglass-start"></i> <?php echo $this->lang->line("start analysis");?> </button>   
						</div>
					</div>
...
<script>
	...
	$(".download").click(function(){
		...
		var url = "<?php echo site_url('keyword/keyword_position_download');?>";
	...
	$(".delete").click(function(){
		...
		if(result)
		{
			...
			var base_url="<?php echo base_url(); ?>";		
			var url = "<?php echo site_url('keyword/keyword_position_delete');?>";
	        var rows = $j("#tt").datagrid("getSelections");
	        var info=JSON.stringify(rows); 
	...
	function get_bulk_progress()
	{
		var base_url="<?php echo base_url(); ?>";			
		$.ajax({
			url:base_url+'keyword/bulk_keyword_position_progress_count',
			type:'POST',
			dataType:'json',
			success:function(response){
				...
				if(width==100) 
				{
					...
					$("#download_div").html('<center><a style="margin: 0px auto;" href="<?php echo base_url()."download/keyword_position/keyword_position_".$this->user_id."_".$this->session->userdata("download_id").".csv"; ?>" target="_blank" class="btn btn-lg btn-warning"><i class="fa fa-cloud-download"></i> <b><?php echo $this->lang->line("download"); ?></b></a></center>');
	...
	$j("document").ready(function(){
		...
		$("#new_search_button").on('click',function(){
			...
			if(domain_name=='')
			{
				alert("<?php echo $this->lang->line('you have not enter any URL'); ?>");
				return false;
			}
					...
					<div class="row">
						<div class="col-xs-12 col-sm-12 col-md-8 col-md-offset-2 col-lg-8 col-lg-offset-2">
							...
							<?php 
								...
								echo "<a href='".base_url()."download/keyword_position/keyword_position_".$this->user_id."_".$download_id.".csv"."'". "title='Download' class='btn btn-warning btn-lg' style='width:200px;'><i class='fa fa-cloud-download' style='color:white'></i> ".$this->lang->line('download')."</a>";							
							?>
							</div>		
