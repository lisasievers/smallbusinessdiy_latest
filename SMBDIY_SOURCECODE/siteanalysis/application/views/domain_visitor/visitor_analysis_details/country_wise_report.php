...
<div role="tabpanel" class="tab-pane" id="country_wise_report">
	...
	<div class="row">
		...
		<div class="col-sm-12 col-md-8 col-md-offset-2 col-lg-8 col-lg-offset-2 hidden-xs">
		...
		<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12" style="margin-top: 25px;"></div>
				...
				<div class="row">
					<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
			          ...
			          <div class="box box-info">
			            <div class="box-header with-border">
			              <h3 class="box-title" style="color: blue; word-spacing: 3px;">Day Wise Sessions Report From <span id="country_name_from_date"></span> to <span id="country_name_to_date"></span></h3>
			              <div class="box-tools pull-right">
			            ...
			            <div class="box-body table-responsive">
			              <div class="chart" id="country_name_line_chart" style="height: 300px; width: 850px;"></div>
			            </div><!-- /.box-body -->
			          </div><!-- /.box -->
			        </div><!-- /.col lg-10 -->
				</div>
