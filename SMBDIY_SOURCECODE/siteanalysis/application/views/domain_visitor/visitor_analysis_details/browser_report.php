		...
		<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
			<div class="box box-primary">
				<div class="box-header with-border">
					<h3 style="color: blue; word-spacing: 3px;" class="box-title"><i class="fa fa-firefox"></i> Report From <span id="browser_table_from_date"></span> To <span id="browser_table_to_date"></span></h3>
	...
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			...
			<div class="modal-header">
				...
				<h4 id="new_search_details_title" class="modal-title"><i class="fa fa-binoculars"></i> Details Information About <span id="id_for_browser_name"></span></h4>
			</div>
				...
				<div class="row">
					<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
			          ...
			          <div class="box box-info">
			            <div class="box-header with-border">
			              <h3 class="box-title" style="color: blue; word-spacing: 4px;">Day Wise Sessions Report From <span id="browser_name_from_date"></span> to <span id="browser_name_to_date"></span></h3>
			              <div class="box-tools pull-right">
			            ...
			            <div class="box-body table-responsive">
			              <div class="chart" id="browser_name_line_chart" style="height: 300px; width: 800px;"></div>
			            </div><!-- /.box-body -->
			          </div><!-- /.box -->
			        </div><!-- /.col lg-10 -->
				</div>
