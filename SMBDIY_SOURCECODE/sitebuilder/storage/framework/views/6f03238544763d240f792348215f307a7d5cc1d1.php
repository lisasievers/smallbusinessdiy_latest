     <div class="row">
        ...
        <div class="col-xs-12 col-md-6 col-md-offset-2">
            <form class="form-horizontal" method="post" id="payment-form" role="form" action="<?php echo e(route('paymentodo.raise')); ?>" >
                ...
                <div class="panel-body">
                    <div class="form-group">
                        ...
                        <div class="input-group" style="width:100%">
                             ...
                             <input id="site_name" type="text" class="form-control" placeholder="Website Name" name="site_name" value="<?php echo e($site_name); ?>">
