...
<div class="col-sm-12"><h2>Please fill form about your website</h2> </div>
        ...
        <form role="form" id="sign_form" method="post" action="<?php echo e(route('webdataform')); ?>" enctype="multipart/form-data" >
          ...
          <div class="form-group">
            <label class="control-label">Website Name *</label>
             <input type="text" required="required" name="site_name" class="form-control webname" value="<?php echo e($sess['site_name']); ?>"/>
         </div>
         <div class="form-group">
         ...
         <div class="form-group">
            ...
            <input type="text" name="menu_list" class="form-control"/>
         </div>
         <div class="form-group">
         ...
         <div class="form-group">
            ...
            <span>( It may describes your business, product or service )</span>
             <input type="text" name="slider1_desc" class="form-control" />
         </div>
         <div class="form-group">
         ...
         <div class="form-group">
            <label class="control-label">Slider's image keyword</label>
             ...
             <input type="text" name="slider2_desc" class="form-control" />
         </div>
         <div class="form-group">
         ...
         <div class="form-group">
            <label class="control-label">Slider's image keyword</label>
             ...
             <input type="text" name="slider3_desc" class="form-control" />
         </div>
          <div class="form-group">
            <label class="control-label">Slider Contents</label>
             <textarea name="slider_headline" class="form-control"></textarea>
         </div>
                </div>
                <div class="tab-img-element col-sm-6 ">
                    <p><img class="sitbuild-screen" src="<?php echo e(url('elements/images/thumbs/header1.png')); ?>" alt="sitebuilder" /></p>
          ...
          <div class="form-group">
            <label class="control-label">About Us contents</label>
             <textarea name="about_us_desc" class="form-control"></textarea>
         </div>
         <div class="form-group">
        ...
        <div class="tab-pane" id="3"><!--our team -->
          <div class="tab-element col-sm-6 ">
            ...
            <label class="control-label">Our Team Headline</label>
             <input type="text" name="team_headline" class="form-control" />
         </div>
          <div class="form-group">
         ...
         <div class="form-group">
            ...
            <textarea name="team1_desc" class="form-control"></textarea>
         </div>
         <div class="form-group">
         ...
         <div class="form-group">
            ...
            <textarea name="team2_desc" class="form-control"></textarea>
         </div>
         <div class="form-group">
         ...
         <div class="form-group">
            ...
            <textarea name="team3_desc" class="form-control"></textarea>
         </div>
         <div class="form-group">
         ...
         <div class="form-group">
            ...
            <textarea name="team4_desc" class="form-control"></textarea>
         </div>
         <div class="form-group">
         ...
         <div class="form-group">
            ...
            <textarea name="team5_desc" class="form-control"></textarea>
         </div>
                </div>
                <div class="tab-img-element col-sm-6 ">
        ...
        <div class="tab-pane" id="4"><!--products-->
          <div class="tab-element col-sm-6 ">
            ...
            <label class="control-label">Our Products Headline</label>
             <input type="text" name="product_headline" class="form-control" />
         </div>
          <div class="form-group">
         ...
         <div class="form-group">
            <label class="control-label">Content-1</label>
            <textarea name="product1_desc" class="form-control"></textarea>
         </div>
         <div class="form-group">
         ...
         <div class="form-group">
            <label class="control-label">Content-2</label>
            <textarea name="product2_desc" class="form-control"></textarea>
         </div>
         <div class="form-group">
         ...
         <div class="form-group">
            <label class="control-label">Content-3</label>
            <textarea name="product3_desc" class="form-control"></textarea>
         </div>
         <div class="form-group">
         ...
         <div class="form-group">
            <label class="control-label">Content-4</label>
            <textarea name="product4_desc" class="form-control"></textarea>
         </div>
         <div class="form-group">
         ...
         <div class="form-group">
            <label class="control-label">Content-5</label>
            <textarea name="product5_desc" class="form-control"></textarea>
         </div>
                </div>
                <div class="tab-img-element col-sm-6 ">
          ...
          <div class="tab-element col-sm-6 ">
            ...
            <label class="control-label">Our Services Headline</label>
             <input type="text" name="service_headline" class="form-control" />
         </div>
          <div class="form-group">
         ...
         <div class="form-group">
            <label class="control-label">Content-1</label>
            <textarea name="service1_desc" class="form-control"></textarea>
         </div>
         <div class="form-group">
         ...
         <div class="form-group">
            <label class="control-label">Content-2</label>
            <textarea name="service2_desc" class="form-control"></textarea>
         </div>
         <div class="form-group">
         ...
         <div class="form-group">
            <label class="control-label">Content-3</label>
            <textarea name="service3_desc" class="form-control"></textarea>
         </div>
         <div class="form-group">
         ...
         <div class="form-group">
            <label class="control-label">Content-4</label>
            <textarea name="service4_desc" class="form-control"></textarea>
         </div>
         <div class="form-group">
         ...
         <div class="form-group">
            <label class="control-label">Content-5</label>
            <textarea name="service5_desc" class="form-control"></textarea>
         </div>
                </div>
                <div class="tab-img-element col-sm-6 ">
         ...
         <div class="form-group">
            ...
            <textarea name="contact_desc" class="form-control"></textarea>
         </div>
          ...
          <div class="tab-element col-sm-6 ">
          <div class="form-group">
            <p class="control-label"><strong>Select Footer Type</strong></p><br>
             <input type="radio" name="footer_type" value="footer1.png" id="f1" checked required /> <label for="f1"><img class="sitbuild-screen" src="<?php echo e(url('elements/images/thumbs/footer1.png')); ?>" alt="sitebuilder" /></label><br>
             <input type="radio" name="footer_type" value="footer2.png" id="f2" required /> <label for="f2"><img class="sitbuild-screen" src="<?php echo e(url('elements/images/thumbs/footer2.png')); ?>" alt="sitebuilder" /></label><br>
             <input type="radio" name="footer_type" value="footer3.png" id="f3" required /> <label for="f3"><img class="sitbuild-screen" src="<?php echo e(url('elements/images/thumbs/footer3.png')); ?>" alt="sitebuilder" /></label><br>
         </div>
         ...
         <div class="form-group">
            ...
            <textarea name="social_media" class="form-control" placeholder="Facebook,Twitter,Google+ ..."></textarea>
         </div>
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control" name="blog1_title" />
             
         </div>
         <div class="form-group">
            <label class="control-label">Blog Description</label>
             <textarea name="blog1_desc" class="form-control"></textarea>
         </div>
         <div class="form-group">
           ...
           <div class="form-group">
            ...
            <input type="text" class="form-control" name="blog2_title" />
             
         </div>
         <div class="form-group">
            <label class="control-label">Blog Description</label>
             <textarea name="blog2_desc" class="form-control"></textarea>
         </div>
         <div class="form-group">
            <label class="control-label">Blog Image</label>
