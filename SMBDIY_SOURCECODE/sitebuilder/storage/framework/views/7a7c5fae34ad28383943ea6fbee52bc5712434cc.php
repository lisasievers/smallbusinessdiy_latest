					...
					<div class="tab-pane active" id="myAccount">
						<form class="form-horizontal" role="form" id="account_details" >
							...
							<div class="form-group">
								...
								<div class="col-md-9">
									<input type="text" class="form-control" id="firstname" name="firstname" placeholder="First name" value="<?php echo e(Auth::user()->first_name); ?>">
								</div>
							</div>
							<div class="form-group">
								<label for="name" class="col-md-3 control-label">Last name</label>
								<div class="col-md-9">
									<input type="text" class="form-control" id="lastname" name="lastname" placeholder="Last name" value="<?php echo e(Auth::user()->last_name); ?>">
								</div>
							</div>
							<div class="form-group">
						...
						<form class="form-horizontal" role="form" id="account_login">
							...
							<div class="form-group">
								...
								<div class="col-md-9">
									<input type="text" class="form-control" id="email" name="email" placeholder="Username" value="<?php echo e(Auth::user()->email); ?>">
								</div>
							</div>
							<div class="form-group">
