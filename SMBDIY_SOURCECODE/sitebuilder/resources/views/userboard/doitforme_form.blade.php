        ...
        <form role="form" id="sign_form" method="post" action="{{ route('webdataform') }}" enctype="multipart/form-data" >
          ...
          <div class="form-group">
            <label class="control-label">Website Name *</label>
             <input type="text" required="required" name="site_name" class="form-control webname" value="{{$sess['site_name']}}"/>
         </div>
         <div class="form-group">
            ...
            <label class="control-label">Slider Contents</label>
             <textarea name="slider_headline" class="form-control"></textarea>
                ...
                <div class="tab-img-element col-sm-6 ">
                    <p><img class="sitbuild-screen" src="{{url('elements/images/thumbs/header1.png')}}" alt="sitebuilder" /></p>
         ...
         <div class="form-group">
          ...
          <div class="form-group">
            <p class="control-label"><strong>Select Footer Type</strong></p><br>
             <input type="radio" name="footer_type" value="footer1.png" id="f1" checked required /> <label for="f1"><img class="sitbuild-screen" src="{{url('elements/images/thumbs/footer1.png')}}" alt="sitebuilder" /></label><br>
             <input type="radio" name="footer_type" value="footer2.png" id="f2" required /> <label for="f2"><img class="sitbuild-screen" src="{{url('elements/images/thumbs/footer2.png')}}" alt="sitebuilder" /></label><br>
             <input type="radio" name="footer_type" value="footer3.png" id="f3" required /> <label for="f3"><img class="sitbuild-screen" src="{{url('elements/images/thumbs/footer3.png')}}" alt="sitebuilder" /></label><br>
         </div>
