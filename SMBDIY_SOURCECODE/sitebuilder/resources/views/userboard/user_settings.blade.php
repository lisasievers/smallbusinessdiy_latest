...
@section('section')
<link href="{{ URL::to('src/css/bootstrap-fileupload.css') }}" rel="stylesheet">
<script src="{{ URL::to('src/js/bootstrap-fileupload.js') }}"></script>
<style>
...
<div class="col-sm-12 ">
	<h2>My Account Settings</h2>
            ...
            @endif
	<div class="col-md-6">
				<form role="form" id="ProSettings" action="{{ route('user.settings') }}" method="post" enctype="multipart/form-data">
                ...
                <div class="control-group">
                          ...
                          <p class="promsg">Click 'Close (X)' to change profile picture. Otherwise leave it.</p>
                           <div class="alert alert-default alert-dismissable " style="background:#ddd">
                            ...
                            <img id="companylogo2c" alt="" width="84" src="{{url('/')}}/src/uploads/users/{{$user->profile_icon}}" />
                          </div>
                          @endif
                          <div>
                   </div>
