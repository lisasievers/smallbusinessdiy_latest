        ...
        "content" style="background-color: #FFFFFF">
          <tr>
            <td id="templateContainerHeader" valign="top" mc:edit="welcomeEdit-01">
              ...
              "https://storage.googleapis.com/assets-sitebuilder/images/SMBDIY_Logo2.png"
              ...
              "brdBottomPadd-two" id="templateContainer" width="100%">
                <tr>
                  <td class="bodyContent" valign="top" mc:edit="welcomeEdit-02">
                    ...
                    <h1><strong>Congratulations! Your registration completed successfully.</strong></h1>
                    ...
                    <table border="0" cellpadding="0" cellspacing="0">
                      <tr>
                        ...
                        "top" width="50" mc:edit="welcomeEdit-03">
                          ...
                          "https://storage.googleapis.com/assets-sitebuilder/images/smbdiy_01.jpg"
                        ...
                        "top" mc:edit="welcomeEdit-04">
                          <h4><strong>Lisa Sievers</strong></h4>
                ...
                <tr valign="top">
                  <td align="center" class="bodyContentTicks">
                    <table border="0" cellpadding="0" cellspacing="0" width="100%">
                      ...
                      <tr valign="top" style="border-bottom:2px solid #ddd">
                        <td valign="top" mc:edit="welcomeEditImgFirst" style="width:19%;color:#505050;font-family:Helvetica;font-size:14px;padding-top:1.143em;">
                          <p style=
                          "text-align:center;margin:0 0 15px 0;padding:0;">
                          <img height="" src=
                          "https://storage.googleapis.com/assets-sitebuilder/images/siskas.png"
                        ...
                        <td valign="top" mc:edit="welcomeEditTxtFirst" style="width:71%;color:#505050;font-family:Helvetica;font-size:14px;padding-top:0.714em;">
                          <h3><strong>Do you need a website? Do IT Yourself</strong></h3>
                          <h4>Take part in our free community. Connect with like minded marketers to exchange ideas. <a href="http://diy.glimpsesvr.com/" target="_blank">Learn more</a></h4>
                        </td>
                      ...
                      <tr valign="top" style="border-bottom:2px solid #ddd">
                        ...
                        <td valign="top" mc:edit="welcomeEditTxtFirst" style="width:71%;color:#505050;font-family:Helvetica;font-size:14px;padding-top:0.714em;">
                          <h3><strong>Do you need a website? Do IT For Me</strong></h3>
                          <h4>Flight plans are best practice methodologies to succeed with marketing automation faster. <a href="http://diy.glimpsesvr.com/" target="_blank">Learn more</a></h4>
                        </td>
                      ...
                      <tr valign="top">
                        ...
                        <td valign="top" mc:edit="welcomeEditTxtFirst">
                          ...
                          <h4>Our community is only as good as its members. Share Flight School with your friends. <a href="http://diy.glimpsesvr.com/sitedoctor/home/havesite" target="_blank">Learn more</a></h4>
                        </td>
              ...
              "templateContainerFooter" width="100%">
                <tr>
                  <td valign="top" width="100%" mc:edit="welcomeEdit-11">
                    ...
                    <h6 style="text-align:center;margin-top: 9px;">Small Business DIY</h6>

                    <h6 style="text-align:center;">751 &#8203;Laurel&#8203; Street,<br/>&#8203;#719, &#8203;San &#8203;Carlos,&#8203;CA,&#8203;USA</h6>
