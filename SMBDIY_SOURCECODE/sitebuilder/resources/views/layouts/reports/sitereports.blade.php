...
<button type="submit" class="btn btn-info">Go to Reports</button>
 ...
 <p>Add more websites, Please click <a href="#"> here</a></p>
  </div>
</div>
  <div class="row">
...
<div class="row">
 ...
 <div class="tools-details">
  ...
  @else
  <div class="row">
  <h2>You are yet to add websites </h2><p>We have below tools for improve your website using these tools. Please active a subscription <a href="{{ route('pricing') }}"> here</a> and continue.</p>
    <div class="col-md-6">
 <div class="tools-details">
      <h3>DIY Doctor</h3>
      <P>SideDoctor can check your website’s health status within a minute. Follow the suggestion provided by the SiteDoctor and make your site more SEO friendly. </P>
