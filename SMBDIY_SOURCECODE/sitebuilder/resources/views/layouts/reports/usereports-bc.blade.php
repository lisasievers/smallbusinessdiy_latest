...
<?php //print_r($site_info); ?> 
                <div class="panel-heading">
                    ...
                    <a href="{{$tools['sitedoctor']}}/index.php/health_check/report/{{$site_info[0]['id']}}/{{$page_title}}"> Learn More</a>
                </div>
<div class="row">
      <div class="col-xs-12">       
        <!-- page title start-->
        ...
        <div class="box box-<?php echo $class;?>">
          ...
          <div class="box-body">  
            <div class="row">
              ...
              <div class="col-xs-12 col-md-3" style="margin-bottom:30px !important;padding-left:12px;min-height:530px;background: url('{{ asset("src/images/mobile.png") }}') no-repeat !important;">
                <?php 
...
@if( isset($domain_info) && count( $domain_info ) > 0 )
...
<?php //print_r($site_info); ?> 
                <div class="panel-heading">
                    ...
                    <a href="{{$tools['sitespy_website']}}/domain/domain_details_view/{{2}}"> Learn More</a>
                </div>
...
<?php //print_r($site_info); ?> 
                <div class="panel-heading">
                    ...
                    <a href="{{$tools['website-review']}}/en/www/{{$page_title}}"> Learn More</a>
                </div>
