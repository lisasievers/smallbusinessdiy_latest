							...
							<div class="form-group">
								<div class="checkbox">
									<label class="checkbox inline">
										...
										type="checkbox" name="cap_e"  /> Enable captcha mode for all SEO tools, to protect from spam and unwanted behaviour.
									</label>
								</div>
							</div>

						<div class="callout callout-warning">
						  <p>Note: If you want to enable captcha protection for specific tools than discheck this box and goto "<a href="/admin/?route=manage-tools">Manage SEO Tools</a>" option.  </p>
                      </div>
