...
?>
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            <li><a href="/admin/?route=admin-accs"><i class="fa fa-server"></i> Admin</a></li>
        ...
        <div class="nav-tabs-custom">
                ...
                <tbody>
                    <tr>
                        <td><img src="<?php echo $theme_path.$admin_logo; ?>" alt="Admin Logo" /></td>         
                    </tr> 
                </tbody>
                </table>
                </div>
...
?>
                ...
                if(isset($msg)){
                    echo $msg;
                                ...
                                <form id="theme_id" method="POST" action="/admin/?route=admin-accs" enctype="multipart/form-data">

                                        <div class="form-group">											
											<label for="logoID">Select image to upload:</label>
											<div class="controls">			   
                                            <img src="<?php echo $theme_path.$admin_logo; ?>" style="text-align:center;"/> <br /><br />
