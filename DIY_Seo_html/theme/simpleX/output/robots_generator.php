...
?>
<script>
var msg1 = "<?php echo $lang['163']; ?>";
var msg2 = "# <?php echo $lang['164']; ?>\n";
</script>
<script src='../core/library/robots.js'></script>
...
Google</td>
  ...
  <option value=" /"><?php echo $lang['152']; ?></option>
        ...
        <p>
		<input type="button" class="btn btn-success" onclick="genRobots(this.form,msg1,msg2)" value="<?php echo $lang['161']; ?>" /> <input type="reset" class="btn btn-primary" value="Clear" /> 
        <br /><br />
        <textarea class="form-control" readonly="" style="height: 270px;" rows="3" name="robolist"></textarea>
        </p>
