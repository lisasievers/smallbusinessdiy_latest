	...
	<div class="row">
            ...
            <div class="xd_top_box">
             <?php echo $ads_720x90; ?>
               ...
               ?>
               <input class="btn btn-info" type="submit" value="<?php echo $lang['94']; ?>" name="submit"/>
               </form>     
            ...
            <br />
            <h3><?php echo $lang['64']; ?> <small> <?php echo $lang['95']; ?></small></h3><br />
              <table class="table table-bordered">
                                    <thead>
                                        <tr>
                                            <td>No.</td>
                                            <td><?php echo $lang['83']; ?></td>
                                            <td><?php echo $lang['96']; ?></td>
                                        </tr>
                                     </thead>
                                        <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><img src="../core/helpers/pagerank/50x/pr<?php echo Trim($pr[$loop]); ?>.png" /></td>
                                        </tr>
                                        <?php } ?>
                                    </tbody></table>
