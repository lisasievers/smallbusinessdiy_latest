            ...
            <div class="xd_top_box">
             <?php echo $ads_720x90; ?>
               ...
               <script>
                ...
                <div class="pageData">
                    <h2 class="smartBlue">Page Speed Score</h2><span id="score"></span><br /><br />
                    <h2 class="smartBlue">Page Code Analysis</h2><span id="code"></span><br /><br />
                    <h2 class="smartBlue">Page Optimization Suggestions</h2>
                    </div><br />
