              ...
              <table class="table table-bordered">
                                    <thead>
                                        ...
                                        <tr>
                                            ...
                                            <?php if ($dmozRes[$loop] == 'Listed') {?>
                                            <td><span class="badge bg-olive"><?php echo $dmozRes[$loop]; ?></span></td>
                                            <?php } else { ?>
                                             <td><span class="badge bg-red"><?php echo $dmozRes[$loop]; ?></span></td>
                                            <?php } ?>
                                        </tr>
                                        <?php } ?>
                                    </tbody></table>
